...
#define D_NV_PROXIMITY_SENSOR_NEAR_SIZE         (0x14)
#define D_NV_PROXIMITY_SENSOR_FAR_SIZE          (0x14)
#define D_NV_PHOTO_SENSOR_BEAMISH_SIZE          (0x02)
#define D_NV_PHOTO_SENSOR_DARK_SIZE             (0x02)
#define D_NV_PHOTO_SENSOR_B_SIZE                (0x14)
#define D_NV_PHOTO_SENSOR_C_SIZE                (0x14)
#define D_NV_PHOTO_SENSOR_D_SIZE                (0x14)
#define D_NV_PHOTO_SENSOR_GA_SIZE               (0x14)
#define D_NV_PROX_PHOTO_COLVAR_SIZE             (0x01)
#define D_NV_PROXIMITY_SENSOR_PPCOUNT_SIZE      (0x50)
...
enum {
    ...
    en_NV_PROXIMITY_SENSOR_PPCOUNT_I,
};
