...
#define MSMFB_MIPI_REG_WRITE  _IOW(MSMFB_IOCTL_MAGIC, 162, struct disp_diag_mipi_reg_type)
#define MSMFB_MIPI_REG_READ   _IOWR(MSMFB_IOCTL_MAGIC, 163, struct disp_diag_mipi_reg_type)
#define MSMFB_DISPLAY_STANDBY _IOW(MSMFB_IOCTL_MAGIC, 164, unsigned int)
#define MSMFB_GET_STATUS  _IOR(MSMFB_IOCTL_MAGIC, 167, struct local_disp_state_type)
#define MSMFB_GET_REF_SW  _IOR(MSMFB_IOCTL_MAGIC, 168, uint8_t)
#define MSMFB_REFRESH_SEQ _IOW(MSMFB_IOCTL_MAGIC, 169, unsigned int)

#define MSMFB_CRC_GET     _IOR(MSMFB_IOCTL_MAGIC, 170, uint32_t)
#define MSMFB_CRC_RESET   _IOW(MSMFB_IOCTL_MAGIC, 171, unsigned int)

#define MSMFB_CHANGE_TRANSFER_RATE  _IOW(MSMFB_IOCTL_MAGIC, 180, uint32_t)
#define MSMFB_DISP_MSG_OUT   _IOW(MSMFB_IOCTL_MAGIC, 182, struct disp_diag_message_out)
