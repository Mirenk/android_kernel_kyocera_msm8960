...
/* -------------------------------------------------------------------------- */
static int  yas_l3g3200d_read_reg(unsigned char, unsigned char *,
				  unsigned char);
static int  yas_l3g3200d_write_reg(unsigned char, unsigned char *,
				   unsigned char);
static int  yas_l3g3200d_read_reg_byte(unsigned char);
...
static int yas_l3g3200d_read_reg(unsigned char adr, unsigned char *buf,
				 unsigned char len)
{
	struct yas_gyro_driver_callback *cbk = &pcb->callback;
...
static int yas_l3g3200d_read_reg_byte(unsigned char adr)
{
	unsigned char buf;
	int err;
...
static int yas_l3g3200d_write_reg_byte(int adr, int val)
{
	return yas_l3g3200d_write_reg((unsigned char)adr,
				      (unsigned char *)&val, 1);
}
