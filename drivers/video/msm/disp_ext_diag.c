...
#else
	mipi_dsi_clk_cfg(1);
    mipi_dsi_cmds_rx(mfd, &dm_dsi_buff_tp,
    	&dm_dsi_buff_rp, &dm_dsi_cmds, mipi_reg_data.r_size);
    mipi_dsi_clk_cfg(0);
#endif
...
#else
        ret = mipi_renesas_cm_lcd_on_exec(mfd);
#endif
        break;
    case 1:
#ifndef CONFIG_FB_MSM_MIPI_DSI_RENESAS_CM
...
#else
        ret = mipi_renesas_cm_lcd_off_exec(mfd);
#endif
        break;
    default:
